...
class CenterNet(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/root/code/AI-Note-Demo/01-ObjectDetection/CenterNet/code/logs/ep004-loss2.341-val_loss0.000.pth',
    ...
    def generate(self, onnx=False):
        ...
        if self.backbone == "resnet50":
            self.net = CenterNet_keypoints_Resnet50(num_classes=self.num_classes, pretrained=False)
        else:
            self.net = CenterNet_keypoints_HourglassNet({'hm': self.num_classes, 'wh': 2, 'reg':2})
